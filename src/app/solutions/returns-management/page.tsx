...
import {
  ...
  ShoppingCart, RefreshCw, Shirt, Cpu,
          ...
          <div className="relative grid gap-6" style={{ gridTemplateColumns: "repeat(6, minmax(0, 1fr))" }}>
            {works.map((w, i) => (
              <div key={i} className="relative text-center px-1">
                <span className="w-7 h-7 rounded-full bg-teal text-white text-[12px] font-bold flex items-center justify-center mx-auto mb-3">{i + 1}</span>
