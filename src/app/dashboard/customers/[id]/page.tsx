...
const tags = ["Wholesale", "Priority", "Repeat Buyer", "High AOV", "West Coast"];
...
const recommendedActions = [
  { label: "Follow up on pending invoice", cta: "View", note: "Due in 2 days", icon: AlertCircle },
  { label: "Offer bulk discount for next order", cta: "Create", note: "Based on purchase history", icon: Tag },
  { label: "Check in on recent support ticket", cta: "View", note: "Last updated 3 days ago", icon: FileText },
];
    ...
    <div className="space-y-5">
          ...
          {tabs.map((t, i) => (
            <button
              ...
              className={`pb-3 text-[13px] font-medium border-b-2 -mb-px ${
                i === 0 ? "border-[#0057D8] text-[#0057D8]" : "border-transparent text-[#66758C] hover:text-[#061A3D]"
              }`}
            >
              {t}
            </button>
      ...
      <div className="grid gap-4" style={{ gridTemplateColumns: "1fr 1.3fr 1.3fr 1fr" }}>
        ...
        <div className="bg-white rounded-xl border border-[#E6EDF5] shadow-[0_1px_3px_rgba(0,0,0,0.1)] p-5">
          <div className="flex items-center justify-between mb-3">
            ...
            <button className="text-[12px] font-medium text-[#0057D8] hover:underline">View all</button>
          </div>
        ...
        <div className="bg-white rounded-xl border border-[#E6EDF5] shadow-[0_1px_3px_rgba(0,0,0,0.1)] p-5">
          <div className="flex items-center justify-between mb-3">
            ...
            <button className="text-[12px] font-medium text-[#0057D8] hover:underline">Edit</button>
          </div>
          ...
          <div className="mt-5 pt-4 border-t border-[#E6EDF5]">
            <div className="flex items-center justify-between mb-3">
              ...
              <button className="text-[12px] font-medium text-[#0057D8] hover:underline">Add Note</button>
            </div>
            <div className="space-y-3">
              {notes.map((n) => (
                <div key={n.date} className="flex items-start gap-2">
            ...
            {recommendedActions.map((a) => {
              ...
              return (
                <div key={a.label} className="flex items-center justify-between gap-2 pb-3 border-b border-[#F1F5F9] last:border-b-0 last:pb-0">
                  ...
                  <button className="px-3 py-1 text-[12px] font-medium text-[#0057D8] border border-[#E6EDF5] rounded-md hover:bg-[#F7FAFC] shrink-0">{a.cta}</button>
                </div>
              );
            })}
          </div>
          <button className="flex items-center gap-1 text-[12px] font-medium text-[#0057D8] hover:underline mt-3">
      ...
      <div className="bg-white rounded-xl border border-[#E6EDF5] shadow-[0_1px_3px_rgba(0,0,0,0.1)] p-5">
        <div className="flex items-center justify-between mb-4">
          ...
          <button className="text-[#9AA8B8] hover:text-[#66758C]"><MoreHorizontal className="w-4 h-4" /></button>
        </div>
