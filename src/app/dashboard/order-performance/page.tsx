          ...
          <div className="flex items-center gap-6 p-5">
            <div className="relative w-[140px] h-[140px] shrink-0">
              <svg viewBox="0 0 100 100" className="w-full h-full -rotate-90">
                ...
                {(() => { let off = 0; return channels.map((c, i) => { const p = parseFloat(c.pct); const dash = `${p * 2.51327} ${251.327 - p * 2.51327}`; const el = <circle key={i} cx="50" cy="50" r="40" fill="none" stroke={c.color} strokeWidth="13" strokeDasharray={dash} strokeDashoffset={-off * 2.51327} />; off += p; return el; }); })()}
              </svg>
