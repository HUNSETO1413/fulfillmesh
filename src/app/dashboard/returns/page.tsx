  ...
  return (
    <div className="space-y-5">
      ...
      <div className="flex items-start justify-between">
        <div>
          <h1 className="text-[24px] font-bold text-[#111827]">Returns</h1>
          <p className="text-[14px] text-[#6B7280] mt-0.5">Manage customer return requests.</p>
        </div>
        <div className="flex items-center gap-3">
          <button className="flex items-center gap-2 px-3.5 py-2 bg-white border border-[#D1D5DB] rounded-lg text-[13px] font-medium text-[#6B7280] hover:bg-[#F9FAFB] hover:border-[#9CA3AF] shadow-[0_1px_2px_rgba(0,0,0,0.05)]">
      ...
      <div className="bg-white rounded-lg border border-[#E2E8F0] shadow-[0_1px_3px_rgba(0,0,0,0.1)]">
          ...
          <div className="flex items-center gap-3 flex-1">
            <div className="relative flex-1 max-w-md">
              ...
              <input
                ...
                className="w-full pl-10 pr-4 py-2 bg-[#F9FAFB] border border-[#E5E7EB] rounded-lg text-[13px] text-[#111827] placeholder:text-[#9CA3AF] focus:outline-none focus:ring-2 focus:ring-[#2563EB]/20 focus:border-[#2563EB]"
              />
            </div>
            <button className="flex items-center gap-2 px-3.5 py-2 bg-white border border-[#D1D5DB] rounded-lg text-[13px] font-medium text-[#6B7280] hover:bg-[#F9FAFB] hover:border-[#9CA3AF]">
              ...
              {returns.map((r) => (
                <tr key={r.id} className="border-b border-[#F3F4F6] last:border-b-0 hover:bg-[#F9FAFB] transition-colors">
                  <td className="px-4 py-3">
                    <Link href={`/dashboard/returns/${r.id}`} className="text-[13px] font-medium text-[#111827] hover:underline hover:text-[#2563EB]">
                      {r.id}
                    </Link>
                  </td>
                  <td className="px-4 py-3 text-[13px] text-[#6B7280]">{r.orderId}</td>
                  <td className="px-4 py-3">
                    <p className="text-[13px] font-medium text-[#111827]">{r.customer}</p>
                    <p className="text-[12px] text-[#6B7280]">{r.email}</p>
                  </td>
                  <td className="px-4 py-3"><StatusBadge status={r.status} /></td>
                  <td className="px-4 py-3 text-[13px] text-[#374151]">{r.reason}</td>
                  <td className="px-4 py-3">
                    <p className="text-[13px] text-[#6B7280]">{r.date}</p>
                  </td>
        ...
        <div className="flex items-center justify-between px-4 py-3 border-t border-[#E5E7EB]">
          <p className="text-[13px] text-[#6B7280]">Showing 1 to 10 of 124 returns</p>
          <div className="flex items-center gap-3">
            <div className="flex items-center gap-1">
              <button className="w-8 h-8 flex items-center justify-center rounded-lg border border-[#D1D5DB] text-[#6B7280] hover:bg-[#F9FAFB] hover:border-[#9CA3AF]">
              ...
              <button className="w-8 h-8 flex items-center justify-center rounded-lg border border-[#D1D5DB] text-[#6B7280] text-[13px] font-medium hover:bg-[#F9FAFB]">2</button>
              <button className="w-8 h-8 flex items-center justify-center rounded-lg border border-[#D1D5DB] text-[#6B7280] text-[13px] font-medium hover:bg-[#F9FAFB]">3</button>
              <span className="px-1 text-[#9CA3AF] text-[13px]">...</span>
              <button className="w-8 h-8 flex items-center justify-center rounded-lg border border-[#D1D5DB] text-[#6B7280] text-[13px] font-medium hover:bg-[#F9FAFB]">13</button>
              <button className="w-8 h-8 flex items-center justify-center rounded-lg border border-[#D1D5DB] text-[#6B7280] hover:bg-[#F9FAFB] hover:border-[#9CA3AF]">
                <ChevronRight className="w-4 h-4" />
              </button>
            </div>
            <button className="flex items-center gap-1.5 px-3 py-1.5 bg-white border border-[#D1D5DB] rounded-lg text-[13px] text-[#6B7280] hover:bg-[#F9FAFB]">
              25 / page
              <ChevronDown className="w-3.5 h-3.5" />
            </button>
          </div>
